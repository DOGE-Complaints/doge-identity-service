...
- **Status:** 🟢 Done
- **source:** [`doge-identity-service/docs/tasks/backlog-stories/phone-verification/STORY-IDS-PV-02-provider-owned-config.md`](../../../../backlog-stories/phone-verification/STORY-IDS-PV-02-provider-owned-config.md)
- **Decision Ref:** [`../../../../backlog-stories/phone-verification/STORY-IDS-PV-02-provider-owned-config.md`](../../../../backlog-stories/phone-verification/STORY-IDS-PV-02-provider-owned-config.md); [`phone-verification-architecture-2026-06-10.md`](../../../../../analysis/phone-verification-architecture-2026-06-10.md) §7, §10.2
- **Источник:** [`phone-verification-architecture-2026-06-10.md`](../../../../../analysis/phone-verification-architecture-2026-06-10.md) §7, §10.2
- **Зависит от:** [STORY-IDS-PV-01-phone-provider-backbone](../STORY-IDS-PV-01-phone-provider-backbone/STORY-IDS-PV-01-phone-provider-backbone.md) (`config_spec` живёт в дескрипторе, Done)

## Зачем простыми словами
Каждый SMS-провайдер сам объявляет свои настройки и сам себя проверяет, а ядро только выбирает активного по `.env` и держит **список разрешённых дозвонных префиксов** (например `+372`). Зеркало eID-конфига ([EID-04](../../../../backlog-stories/eid/STORY-IDS-EID-04-provider-owned-config.md)).
...
## Вне scope
- `TELNYX_*` поля и их settings — [PV-06](../../../../backlog-stories/phone-verification/STORY-IDS-PV-06-telnyx-sms-sender.md) (со своим `config_spec`, как у Authentigate).
...
|---|---|---|
| 1 | [`task-ids-10-02-t01-sms-provider-config-spec`](./task-ids-10-02-t01-sms-provider-config-spec/README.md) | pkg-000023 |
| 2 | [`task-ids-10-02-t02-appconfig-phone-fields-sms-provider-validation`](./task-ids-10-02-t02-appconfig-phone-fields-sms-provider-validation/README.md) | pkg-000023 |
| 3 | [`task-ids-10-02-t03-e164-normalize-prefix-allowlist`](./task-ids-10-02-t03-e164-normalize-prefix-allowlist/README.md) | pkg-000023 |
| 4 | [`task-ids-10-02-t04-env-example-phone-block`](./task-ids-10-02-t04-env-example-phone-block/README.md) | pkg-000023 |
| 5 | [`task-ids-10-02-t05-offline-phone-config-e164-tests`](./task-ids-10-02-t05-offline-phone-config-e164-tests/README.md) | pkg-000023 |
| 6 | [`task-ids-10-02-t06-story-acceptance-verification`](./task-ids-10-02-t06-story-acceptance-verification/README.md) | pkg-000023 |
