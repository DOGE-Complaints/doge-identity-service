...
- **Зависит от:** [PV-01](STORY-IDS-PV-01-phone-provider-backbone.md), [PV-02](STORY-IDS-PV-02-provider-owned-config.md) (параметры OTP)
...
## Вне scope
- HTTP-эндпоинты/оркестрация/rate-limit на отправку — [PV-05](STORY-IDS-PV-05-verification-flow-api.md).
- Запись флага в профиль и дедуп — [PV-04](STORY-IDS-PV-04-profile-flag-migration.md).
